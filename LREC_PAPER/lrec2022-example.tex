...
To measure diachronic lexical semantic change of a token, we use 4 different methods, per \newcite{Kutuzov2020,Giulianelli2020}. Given all embedded instances of a token $w$ in two time periods $t, t'$, we define word usage matrices $\textbf{U}^{t}_w, \textbf{U}^{t'}_w$.
